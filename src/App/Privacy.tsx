    ...
    render() {
        ...
        return (
            <div style={{padding:20}}>
                ...
                <p>Weeatcher ("us", "we", or "our") operates the Weeatcher mobile application (the "Service").</p>
                ...
                <p>We don't collect any of your personal info, including your IP address, other than information you voluntarily provide.</p>
                ...
                <p>Weeatcher uses the collected data for various purposes:</p>
                <ul>
                ...
                <p>Weeatcher will take all steps reasonably necessary to ensure that your data is treated securely and in accordance with this Privacy Policy and no transfer of your Personal Data will take place to an organization or a country unless there are adequate controls in place including the security of your data and other personal information.</p>

                <h2>Disclosure Of Data</h2>

                <h3>Legal Requirements</h3>
                <p>Weeatcher may disclose your Personal Data in the good faith belief that such action is necessary to:</p>
                <ul>
                    <li>To comply with a legal obligation</li>
                    <li>To protect and defend the rights or property of Weeatcher</li>
                ...
                <ul>
                    <li>By email: weeatcher@gmail.com</li>
                </ul>
            </div>
        )
    }
